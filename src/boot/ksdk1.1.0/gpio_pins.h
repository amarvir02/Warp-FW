 ...
 *	PTA8						ADC0_SE2	ALT1
 *	PTA9						ADC0_SE2	ALT1
 *	PTA12/IRQ_13/LPTMR0_ALT2	ADC0_SE0	ALT1 //!! my interrupt for MMA8451
 *
...
enum _gpio_pins
{
	...
	//!!
	// INCLUDE FRDM OLED PINS HERE COS WHY NOT
	...
	// counted as "Not GPIO" as per gpio_pins.c
		...
		//kWarpPinI2C0_SCL			= GPIO_MAKE_PIN(HW_GPIOB, 3), -- automatically done
		...
		kSSD1331PinMOSI				= GPIO_MAKE_PIN(HW_GPIOA, 8),
		kSSD1331PinSCK				= GPIO_MAKE_PIN(HW_GPIOA, 9),
		//kWarpPinUnusedPTA2			= GPIO_MAKE_PIN(HW_GPIOA, 12)
		kSSD1331PinDC				= GPIO_MAKE_PIN(HW_GPIOA, 12),
	#else
		#if (WARP_BUILD_ENABLE_GLAUX_VARIANT)
